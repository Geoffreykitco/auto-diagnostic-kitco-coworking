      ...
      <div className="flex flex-col items-center mt-8">
        <Dialog>
          <DialogTrigger asChild>
            ...
            scale: 0.98
          }} className="bg-primary hover:bg-primary-hover text-white px-8 py-3 rounded-md font-semibold shadow-[0_4px_12px_rgba(19,39,32,0.2)] hover:shadow-[0_8px_16px_rgba(19,39,32,0.3)] transition-all duration-300">🔽 Recevoir mon audit et passer à d’action
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-0">
              <div className="h-[600px]">
                <div className="h-full bg-gray-50 relative">
                  <img src={photoPreview} alt="Personnes collaborant dans un espace de coworking" className="h-full w-full object-cover rounded-l-xl" />
              ...
              <div className="p-6 space-y-4">
                ...
                scale: 0.98
              }} type="submit" className="w-full bg-primary hover:bg-primary-hover text-white font-semibold py-3 px-8 rounded-lg shadow-md transition-all duration-200 mt-4">
                  Envoyer
                </motion.button>
              </div>
            </form>
