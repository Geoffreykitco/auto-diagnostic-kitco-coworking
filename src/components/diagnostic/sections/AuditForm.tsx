  ...
  return <motion.div initial={{
    ...
    delay: 0.5
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">Vous avez maintenant une vision claire de la performance de votre espace de coworking et de vos axes de développements.</p>
      </div>
          ...
          <DialogContent className="sm:max-w-[1000px] overflow-hidden rounded-xl">
            <div className="flex flex-col md:flex-row w-full h-[600px]">
              <div className="w-full md:w-1/2 h-full">
                <img src={photoPreview} alt="Personnes collaborant dans un espace de coworking" className="h-full w-full object-cover" />
              </div>
