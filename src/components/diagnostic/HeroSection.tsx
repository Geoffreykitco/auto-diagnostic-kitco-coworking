  ...
  <section className="hero-pattern py-20 px-4">
    <div className="container mx-auto max-w-4xl">
      ...
      >
        ...
        <motion.button
          onClick={onStart}
          className="glass-morphism px-8 py-3 border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300 rounded-md font-medium shadow-xl hover:shadow-2xl"
