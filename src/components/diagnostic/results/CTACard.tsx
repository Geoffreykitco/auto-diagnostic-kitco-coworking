        ...
        <div className="text-center space-y-2">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <button className="mt-4 bg-[#0B1A17] text-white px-8 py-3 rounded-lg hover:bg-[#132721] transition-colors duration-200 hover:scale-[1.02] transform text-sm md:text-base">
          ...
          <p className="font-medium mt-2 text-gray-500 text-xs">
