...
export const MainContent = ({
  ...
  return <div className={`${isMobile ? 'w-full max-w-full overflow-x-hidden' : 'max-w-5xl'} mx-auto px-4 py-4`}>
      <div className="text-center space-y-1.5">
        <h2 className="text-xl font-bold text-black py-0 text-center md:text-xl">
        ...
        <p className="max-w-2xl mx-auto text-xs font-bold md:text-lg text-gray-600">Kitco par le fondateur de l'espace de coworking au19 qui dispose d'un taux de remplissage moyen de 83% grâce à cette méthode de travail.</p>
