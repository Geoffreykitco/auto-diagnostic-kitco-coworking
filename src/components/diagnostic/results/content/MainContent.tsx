...
export const MainContent = ({
  ...
  return (
    <div className={`${isMobile ? 'w-full max-w-full overflow-x-hidden' : 'max-w-5xl'} mx-auto px-4 py-4`}>
      <div className="text-center space-y-1.5">
        <h2 className="text-lg sm:text-xl font-bold text-black py-0 text-center">
        ...
        <p className="max-w-2xl mx-auto text-xs font-bold sm:text-base md:text-lg text-gray-600">
        ...
        <div>
          <a href="https://calendar.app.google/9xhMZ7tDMArPJzFt5" target="_blank" rel="noopener noreferrer">
            <Button variant="audit" className="mt-2 text-base sm:text-lg rounded-md my-[10px] px-[15px] sm:px-[20px] py-[15px] sm:py-[20px]">
