  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-sm">
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-[#0B1A17] mb-3">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0B1A17] focus:border-transparent transition-all"
              required
            />
          </div>
          ...
          <button
            ...
            className="w-full bg-[#0B1A17] text-white py-3.5 rounded-lg font-medium hover:bg-[#132721] transition-all disabled:opacity-50 mt-6"
          >
